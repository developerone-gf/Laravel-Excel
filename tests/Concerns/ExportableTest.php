...
class ExportableTest extends TestCase
{
    ...
    {
        $this->expectException(\Developergf\Excel\Exceptions\NoFilenameGivenException::class);
    ...
    {
        $this->expectException(\Developergf\Excel\Exceptions\NoFilePathGivenException::class);
